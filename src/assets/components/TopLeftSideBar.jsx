...
function TopLeftSideBar() {
    return (
        <div>
            <div className="text-white flex justify-between p-4">
                <div>
                    <img src="../../../public/DukaanLogo.png" className="w-10"/>
                </div>
                <div className="w-28">
                    <div className="text-sm mb-2">
                        Nishyan
                    </div>
                    {/* need to change the font size and character spacing */}
            ...
            <div className="m-2">
            <div className="flex p-[8px] hover:bg-[#353C53]">
